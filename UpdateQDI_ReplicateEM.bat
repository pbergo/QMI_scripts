...
DEL /S /Q *.txt
DEL /S /Q *.url
IF NOT EXIST "QlikReplicate_Lab_Env_Information.txt" QlikWGET -O QlikUNZIP.EXE https://github.com/pbergo/QMI_scripts/raw/master/QlikReplicate_Lab_Env_Information.txt --append-output=UpdateQDI.log
